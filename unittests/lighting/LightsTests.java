...
public class LightsTests {
     ...
     */
    @Test
    public void testSphereMulti() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(new Color(GREEN), new Point(20, 0, 50), new Vector(0, 0, -1)).setKl(0.0001).setKq(0.000004));
        ...
        camera1.setImageWriter(new ImageWriter("lightSphereMulti", 500, 500)).build().renderImage().writeToImage();
    }
     ...
     */
    @Test
    public void testTriangleMulti() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(new Color(GREEN), new Point(20, 0, 50), new Vector(0, 0, -1)).setKl(0.0001).setKq(0.000004));
        scene2.lights.add(new PointLight(new Color(RED), new Point(100, 20, 5)).setKl(0.0001).setKq(0.000002));
        scene2.lights.add(new DirectionalLight(new Color(BLUE), new Vector(1, -2, -1)));

        camera2.setImageWriter(new ImageWriter("lightTriangleMulti", 500, 500)).build().renderImage().writeToImage();
    }
}
