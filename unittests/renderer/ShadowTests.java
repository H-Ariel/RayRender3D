...
public class ShadowTests {
    ...
    /**
     * Produce a picture of two triangles lighted by a spotlight with a Sphere producing a shading
     */
    @Test
    ...
    /**
     * same to trianglesSphere, but with soft-shadows
     */
    @Test
    public void trianglesSphere_SoftShadow() {
        ...
        scene.lights.add(
                new SpotLight(new Color(700, 400, 400), new Point(40, 40, 115), new Vector(-1, -1, -4))
                        .setKl(4E-4).setKq(2E-5).setShadowSoftness(5));

        camera.setImageWriter(new ImageWriter("shadowTrianglesSphere-SoftShadow", 600, 600))
                .build()
                .renderImage()
                .writeToImage();
    }
