...
public class TeapotTest {
     ...
     * ball's material 1
     */
    private static final Material ballMaterial1 = new Material().setKd(0.5).setKs(0.5).setShininess(60);
    /**
     * ball's material 2
     */
    private static final Material ballMaterial2 = new Material().setKd(0.5).setKs(0.5).setShininess(60);
    /**
    ...
    /**
     * Returns lit of geometries to design a teapot
     *
     * @return list of geometries
     */
    private static List<Intersectable> getTeapot() {
        final Point[] pnts = new Point[]{null,
        ...
        return List.of(new Triangle(pnts[7], pnts[6], pnts[1]).setEmission(color).setMaterial(mat),
    ...
    @Test
    public void teapot() {
        scene.geometries.add(getTeapot());
        ...
        */
        ...
        for (int i = 0; i < 360; i += 10) {
            ...
            scene.geometries.add(
                    new Sphere(new Point(x, y, z), 5).setEmission(ballColor1).setMaterial(ballMaterial1),
                    new Sphere(new Point(-x, y, z), 5).setEmission(ballColor2).setMaterial(ballMaterial2)
            );
        ...
        XmlParser.saveSceneToXml(scene, "./xml/teapot.xml");
    }

    /**
     * same to teapot but load from xml file
     */
    @Test
    void teapotFromXml() {
        camera.setRayTracer(new SimpleRayTracer(XmlParser.loadSceneFromXml("./xml/teapot.xml")))
